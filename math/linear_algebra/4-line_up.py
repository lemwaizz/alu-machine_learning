...
def add_arrays(arr1, arr2):
    ...
    Args:
        arr1 (list of int/float or list of list of int/float): The first array.
        arr2 (list of int/float or list of list of int/float): The second array.
    
    Returns:
        list of int/float or list of list of int/float: The resulting array after addition.
    ...
    if isinstance(arr1[0], list) and isinstance(arr2[0], list):
        ...
        result_matrix = [[0 for _ in range(len(arr1[0]))] for _ in range(len(arr1))]
